...
ActiveRecord::Schema.define(:version => 20180625081158) do
  ...
  add_index "cash_desk_closing_items", ["cash_movement_id"], :name => "index_cash_desk_closing_items_on_cash_movement_id"
  add_index "cash_desk_closing_items", ["client_payment_id"], :name => "index_cash_desk_closing_items_on_client_payment_id"
  add_index "cash_desk_closing_items", ["payment_method_id"], :name => "index_cash_desk_closing_items_on_payment_method_id"
  ...
  create_table "cash_movement_types", :force => true do |t|
    ...
    t.string   "name"
    t.integer  "type_id",         :limit => 2, :default => 1, :null => false
    t.integer  "organization_id"
    t.datetime "created_at",                                  :null => false
    t.datetime "updated_at",                                  :null => false
    t.integer  "created_by"
  ...
  add_index "cash_movements", ["cash_movement_type_id"], :name => "index_cash_movements_on_cash_movement_type_id"
  add_index "cash_movements", ["charge_account_id"], :name => "index_cash_movements_on_charge_account_id"
  add_index "cash_movements", ["company_id"], :name => "index_cash_movements_on_company_id"
  add_index "cash_movements", ["movement_date"], :name => "index_cash_movements_on_movement_date"
  add_index "cash_movements", ["office_id"], :name => "index_cash_movements_on_office_id"
  add_index "cash_movements", ["organization_id"], :name => "index_cash_movements_on_organization_id"
  add_index "cash_movements", ["payment_method_id"], :name => "index_cash_movements_on_payment_method_id"
  add_index "cash_movements", ["project_id"], :name => "index_cash_movements_on_project_id"
  ...
  create_table "debt_claim_items", :force => true do |t|
    ...
    t.integer  "created_by"
    t.integer  "updated_by"
    t.decimal  "debt",                 :precision => 12, :scale => 4, :default => 0.0, :null => false
  end
  ...
  add_index "debt_claims", ["office_id"], :name => "index_debt_claims_on_office_id"
  ...
  create_table "invoice_current_debts", :id => false, :force => true do |t|
    ...
    t.date    "invoice_date"
    t.date    "payday_limit"
    t.decimal "subtotal",             :precision => 13, :scale => 4, :default => 0.0, :null => false
    t.decimal "taxes",                :precision => 13, :scale => 4, :default => 0.0, :null => false
    t.decimal "bonus",                :precision => 13, :scale => 4, :default => 0.0, :null => false
    t.decimal "taxable",              :precision => 13, :scale => 4, :default => 0.0, :null => false
    t.decimal "total",                :precision => 13, :scale => 4, :default => 0.0, :null => false
    t.decimal "paid",                 :precision => 34, :scale => 4
    t.decimal "calc_debt",            :precision => 35, :scale => 4
    t.decimal "totals",               :precision => 13, :scale => 4, :default => 0.0, :null => false
  ...
  create_table "invoices", :force => true do |t|
    ...
    t.string   "old_no"
    t.decimal  "subtotals",             :precision => 13, :scale => 4, :default => 0.0, :null => false
    t.decimal  "bonuses",               :precision => 13, :scale => 4, :default => 0.0, :null => false
  ...
  add_index "meters", ["master_meter_id"], :name => "index_meters_on_master_meter_id"
  ...
  create_table "offices", :force => true do |t|
    ...
    t.boolean  "closed_blocks",                                                                     :default => true, :null => false
  end
  ...
  create_table "processed_file_items", :force => true do |t|
    ...
    t.string  "multiple_processed_id"
  end
  ...
  add_index "processed_file_items", ["multiple_processed_id"], :name => "index_processed_file_items_on_multiple_processed_id"
  ...
  create_table "purchase_order_item_invoiced_balances", :id => false, :force => true do |t|
    t.integer "purchase_order_item_id",                                      :default => 0,   :null => false
    t.decimal "purchase_order_item_quantity", :precision => 12, :scale => 4, :default => 0.0, :null => false
  ...
  create_table "readings", :force => true do |t|
    ...
    t.binary   "image",                :limit => 16777215
    t.integer  "service_point_id"
    t.integer  "coefficient",          :limit => 2,                                        :default => 1, :null => false
  end
