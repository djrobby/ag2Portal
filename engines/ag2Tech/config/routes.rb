Ag2Tech::Engine.routes.draw do
  scope "(:locale)", :locale => /en|es/ do
    ...
    match 'work_orders/wo_update_product_select_from_organization/:org/:id', :controller => 'work_orders', :action => 'wo_update_product_select_from_organization'
    match 'wo_update_product_select_from_organization/:org/:id', :controller => 'work_orders', :action => 'wo_update_product_select_from_organization'
    match 'work_orders/:id/wo_update_product_select_from_organization/:org/:id', :controller => 'work_orders', :action => 'wo_update_product_select_from_organization'
    match 'work_orders/wo_update_tool_select_from_organization/:org/:id', :controller => 'work_orders', :action => 'wo_update_tool_select_from_organization'
    match 'wo_update_tool_select_from_organization/:org/:id', :controller => 'work_orders', :action => 'wo_update_tool_select_from_organization'
    match 'work_orders/:id/wo_update_tool_select_from_organization/:org/:id', :controller => 'work_orders', :action => 'wo_update_tool_select_from_organization'
    match 'work_orders/wo_update_vehicle_select_from_organization/:org/:id', :controller => 'work_orders', :action => 'wo_update_vehicle_select_from_organization'
    match 'wo_update_vehicle_select_from_organization/:org/:id', :controller => 'work_orders', :action => 'wo_update_vehicle_select_from_organization'
    match 'work_orders/:id/wo_update_vehicle_select_from_organization/:org/:id', :controller => 'work_orders', :action => 'wo_update_vehicle_select_from_organization'
    match 'work_orders/wo_update_worker_select_from_organization/:org/:id', :controller => 'work_orders', :action => 'wo_update_worker_select_from_organization'
    match 'wo_update_worker_select_from_organization/:org/:id', :controller => 'work_orders', :action => 'wo_update_worker_select_from_organization'
    match 'work_orders/:id/wo_update_worker_select_from_organization/:org/:id', :controller => 'work_orders', :action => 'wo_update_worker_select_from_organization'
