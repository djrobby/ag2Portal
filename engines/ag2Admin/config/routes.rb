Ag2Admin::Engine.routes.draw do
  scope "(:locale)", :locale => /en|es/ do
    ...
    match 'companies/co_update_total_and_price/:total/:price/:overtime', :controller => 'companies', :action => 'co_update_total_and_price'
    match 'co_update_total_and_price/:total/:price/:overtime', :controller => 'companies', :action => 'co_update_total_and_price'
    match 'companies/:id/co_update_total_and_price/:total/:price/:overtime', :controller => 'companies', :action => 'co_update_total_and_price'
    ...
    match 'offices/co_update_total_and_price/:total/:price/:overtime', :controller => 'companies', :action => 'co_update_total_and_price'
    match 'co_update_total_and_price/:total/:price/:overtime', :controller => 'companies', :action => 'co_update_total_and_price'
    match 'offices/:id/co_update_total_and_price/:total/:price/:overtime', :controller => 'companies', :action => 'co_update_total_and_price'
    #
    # Entities
