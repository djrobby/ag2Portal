Ag2Purchase::Engine.routes.draw do
  scope "(:locale)", :locale => /en|es/ do
    ...
    match 'suppliers/su_validate_iban/:iban', :controller => 'suppliers', :action => 'su_validate_iban'
    match 'su_validate_iban/:iban', :controller => 'suppliers', :action => 'su_validate_iban'
    match 'suppliers/:id/su_validate_iban/:iban', :controller => 'suppliers', :action => 'su_validate_iban'
    ...
    match 'si_update_charge_account_from_order/:order', :controller => 'supplier_invoices', :action => 'si_update_charge_account_from_order'
    ...
    match 'supplier_invoices/si_update_selects_from_company/:org', :controller => 'supplier_invoices', :action => 'si_update_selects_from_company'
    match 'si_update_selects_from_company/:org', :controller => 'supplier_invoices', :action => 'si_update_selects_from_company'
    match 'supplier_invoices/:id/si_update_selects_from_company/:org', :controller => 'supplier_invoices', :action => 'si_update_selects_from_company'
    ...
    match 'supplier_invoices/si_update_selects_from_order/:o', :controller => 'supplier_invoices', :action => 'si_update_selects_from_order'
    match 'si_update_selects_from_order/:o', :controller => 'supplier_invoices', :action => 'si_update_selects_from_order'
    match 'supplier_invoices/:id/si_update_selects_from_order/:o', :controller => 'supplier_invoices', :action => 'si_update_selects_from_order'
    match 'supplier_invoices/si_update_selects_from_note_and_order/:o/:p', :controller => 'supplier_invoices', :action => 'si_update_selects_from_note_and_order'
    match 'si_update_selects_from_note_and_order/:o/:p', :controller => 'supplier_invoices', :action => 'si_update_selects_from_note_and_order'
    match 'supplier_invoices/:id/si_update_selects_from_note_and_order/:o/:p', :controller => 'supplier_invoices', :action => 'si_update_selects_from_note_and_order'
    ...
    match 'supplier_invoices/si_update_product_select_from_order_item/:i', :controller => 'supplier_invoices', :action => 'si_update_product_select_from_order_item'
    match 'si_update_product_select_from_order_item/:i', :controller => 'supplier_invoices', :action => 'si_update_product_select_from_order_item'
    match 'supplier_invoices/:id/si_update_product_select_from_order_item/:i', :controller => 'supplier_invoices', :action => 'si_update_product_select_from_order_item'
    match 'supplier_invoices/si_update_product_select_from_note_and_order/:o/:p', :controller => 'supplier_invoices', :action => 'si_update_product_select_from_note_and_order'
    match 'si_update_product_select_from_note_and_order/:o/:p', :controller => 'supplier_invoices', :action => 'si_update_product_select_from_note_and_order'
    match 'supplier_invoices/:id/si_update_product_select_from_note_and_order/:o/:p', :controller => 'supplier_invoices', :action => 'si_update_product_select_from_note_and_order'
    ...
    match 'supplier_invoices/si_purchase_order_item_balance_check/:i/:qty', :controller => 'supplier_invoices', :action => 'si_purchase_order_item_balance_check'
    match 'si_purchase_order_item_balance_check/:i/:qty', :controller => 'supplier_invoices', :action => 'si_purchase_order_item_balance_check'
    match 'supplier_invoices/:id/si_purchase_order_item_balance_check/:i/:qty', :controller => 'supplier_invoices', :action => 'si_purchase_order_item_balance_check'
