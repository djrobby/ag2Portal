Ag2Purchase::Engine.routes.draw do
  scope "(:locale)", :locale => /en|es/ do
    ...
    match 'supplier_invoices/si_update_description_prices_from_product/:product/:qty/:supplier', :controller => 'supplier_invoices', :action => 'si_update_description_prices_from_product'
    match 'si_update_description_prices_from_product/:product/:qty/:supplier', :controller => 'supplier_invoices', :action => 'si_update_description_prices_from_product'
    match 'supplier_invoices/:id/si_update_description_prices_from_product/:product/:qty/:supplier', :controller => 'supplier_invoices', :action => 'si_update_description_prices_from_product'
    ...
    match 'supplier_invoices/si_item_totals/:qty/:amount/:tax/:discount_p/:tbl', :controller => 'supplier_invoices', :action => 'si_item_totals'
    match 'si_item_totals/:qty/:amount/:tax/:discount_p/:tbl', :controller => 'supplier_invoices', :action => 'si_item_totals'
    match 'supplier_invoices/:id/si_item_totals/:qty/:amount/:tax/:discount_p/:tbl', :controller => 'supplier_invoices', :action => 'si_item_totals'
    ...
    #
    # Offer requests
    match 'offer_requests/or_totals/:qty/:amount/:tax/:discount_p/:tbl', :controller => 'offer_requests', :action => 'or_totals'
    match 'or_totals/:qty/:amount/:tax/:discount_p/:tbl', :controller => 'offer_requests', :action => 'or_totals'
    match 'offer_requests/:id/or_totals/:qty/:amount/:tax/:discount_p/:tbl', :controller => 'offer_requests', :action => 'or_totals'
    ...
    #
    # Offers
    match 'offers/of_totals/:qty/:amount/:tax/:discount_p/:tbl', :controller => 'offers', :action => 'of_totals'
    match 'of_totals/:qty/:amount/:tax/:discount_p/:tbl', :controller => 'offers', :action => 'of_totals'
    match 'offers/:id/of_totals/:qty/:amount/:tax/:discount_p/:tbl', :controller => 'offers', :action => 'of_totals'
    match 'offers/of_update_description_prices_from_product_store/:product/:qty/:store/:supplier', :controller => 'offers', :action => 'of_update_description_prices_from_product_store'
    match 'of_update_description_prices_from_product_store/:product/:qty/:store/:supplier', :controller => 'offers', :action => 'of_update_description_prices_from_product_store'
    match 'offers/:id/of_update_description_prices_from_product_store/:product/:qty/:store/:supplier', :controller => 'offers', :action => 'of_update_description_prices_from_product_store'
