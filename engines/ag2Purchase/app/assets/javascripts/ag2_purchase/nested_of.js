/*
 * Methods to add 'fields' to the Offer Items table 
 * Very important!!:
...
var of_itemFieldsUI = {
    init: function(sel2NoMatches) {
        ...
        $('#addButton').on('click', function(e) {
            ...
            of_formHandler.appendFields(sel2NoMatches);
            of_formHandler.hideForm();
        });

        $('#cancelButton').on('click', function(e) {
          of_formHandler.removeFields();
          of_formHandler.hideForm();
        });
    }
};
...
var of_formHandler = {
    ...
    appendFields: function (sel2NoMatches) {
        ...
        var inputFields = $(of_cfg.formId + ' ' + of_cfg.inputFieldClassSelector);
        inputFields.detach();

        // Build the row and add it to the end of the table.
        of_rowBuilder.addRow(of_cfg.getTBodySelector(), inputFields);
    ...
    hideForm: function() {
        ...
        // Hide modal
        $(of_cfg.formId).modal('hide');
    }
};

var of_rowBuilder = function() {
