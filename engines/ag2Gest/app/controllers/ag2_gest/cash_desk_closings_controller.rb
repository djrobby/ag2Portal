...
module Ag2Gest
  class CashDeskClosingsController < ApplicationController
    ...
    def show
      ...
      @cash_desk_closing_instruments = @cash_desk_closing.cash_desk_closing_instruments
      @cash_desk_closing_items = @cash_desk_closing.cash_desk_closing_items.joins(:client_payment).order('client_payments.payment_method_id')
