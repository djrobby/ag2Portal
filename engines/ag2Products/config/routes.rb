Ag2Products::Engine.routes.draw do
  scope "(:locale)", :locale => /en|es/ do
    ...
    match 'delivery_notes/dn_update_product_select_from_organization/:org', :controller => 'delivery_notes', :action => 'dn_update_product_select_from_organization'
    match 'dn_update_product_select_from_organization/:org', :controller => 'delivery_notes', :action => 'dn_update_product_select_from_organization'
    match 'delivery_notes/:id/dn_update_product_select_from_organization/:org', :controller => 'delivery_notes', :action => 'dn_update_product_select_from_organization'
    ...
    match 'receipt_notes/rn_update_product_select_from_organization/:org', :controller => 'receipt_notes', :action => 'rn_update_product_select_from_organization'
    match 'rn_update_product_select_from_organization/:org', :controller => 'receipt_notes', :action => 'rn_update_product_select_from_organization'
    match 'receipt_notes/:id/rn_update_product_select_from_organization/:org', :controller => 'receipt_notes', :action => 'rn_update_product_select_from_organization'
    ...
    match 'inventory_counts/ic_update_type_select_from_store/:store', :controller => 'inventory_counts', :action => 'ic_update_type_select_from_store'
    match 'ic_update_type_select_from_store/:store', :controller => 'inventory_counts', :action => 'ic_update_type_select_from_store'
    match 'inventory_counts/:id/ic_update_type_select_from_store/:store', :controller => 'inventory_counts', :action => 'ic_update_type_select_from_store'
    ...
    match 'inventory_counts/ic_update_product_select_from_organization/:org', :controller => 'inventory_counts', :action => 'ic_update_product_select_from_organization'
    match 'ic_update_product_select_from_organization/:org', :controller => 'inventory_counts', :action => 'ic_update_product_select_from_organization'
    match 'inventory_counts/:id/ic_update_product_select_from_organization/:org', :controller => 'inventory_counts', :action => 'ic_update_product_select_from_organization'
