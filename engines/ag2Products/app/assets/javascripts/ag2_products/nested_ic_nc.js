...
var ic_nc_itemFieldsUI = {
    init: function(sel2NoMatches) {
        ...
        $('#addButton').on('click', function(e) {
            ...
            ic_nc_formHandler.appendFields(sel2NoMatches);
            ic_nc_formHandler.hideForm();
        });

        $('#cancelButton').on('click', function(e) {
          ic_nc_formHandler.removeFields();
          ic_nc_formHandler.hideForm();
        });
    }
};
...
var ic_nc_cfg = {
    formId: '#new-item-fields-nc',
    tableId: '#items-table-nc',
...
var ic_nc_formHandler = {
    ...
    appendFields: function (sel2NoMatches) {
        ...
        var inputFields = $(ic_nc_cfg.formId + ' ' + ic_nc_cfg.inputFieldClassSelector);
        inputFields.detach();

        // Build the row and add it to the end of the table.
        ic_nc_rowBuilder.addRow(ic_nc_cfg.getTBodySelector(), inputFields);
...
var ic_nc_rowBuilder = function() {
    ...
    var link = $('<a>', {
        href: '#',
        onclick: 'remove_fields(this); $("#items-table-nc").trigger("totals"); return false;'
        ...
        $(fields).map(function() {
            ...
            if (this.id.indexOf("s2") == -1) {
              ...
              if ($(this).hasClass('fsel2') && id == 'fnt-product') {
                ...
                if (id === 'fnt-initial' || id === 'fnt-current' ||
                  id === 'fnt-average-price' || id === 'fnt-price') {
