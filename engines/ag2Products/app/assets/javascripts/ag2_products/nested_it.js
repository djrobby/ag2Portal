/*
 * Methods to add 'fields' to the Inventory Transfer Items table 
 * Very important!!:
...
var it_itemFieldsUI = {
    init: function(sel2NoMatches) {
        ...
        $('#addButton').on('click', function(e) {
            ...
            it_formHandler.appendFields(sel2NoMatches);
            it_formHandler.hideForm();
        });

        $('#cancelButton').on('click', function(e) {
          it_formHandler.removeFields();
          it_formHandler.hideForm();
        });
    }
};
...
var it_formHandler = {
    ...
    appendFields: function (sel2NoMatches) {
        ...
        var inputFields = $(it_cfg.formId + ' ' + it_cfg.inputFieldClassSelector);
        inputFields.detach();

        // Build the row and add it to the end of the table.
        it_rowBuilder.addRow(it_cfg.getTBodySelector(), inputFields);
    ...
    hideForm: function() {
        ...
        // Hide modal
        $(it_cfg.formId).modal('hide');
    }
};

var it_rowBuilder = function() {
